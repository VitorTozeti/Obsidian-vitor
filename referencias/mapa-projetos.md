...
| KEMY_AI | `kemy-ai` 🟦 #2196F3 | `projetos/KEMY_AI/` | [[KEMY_AI]] | [[KEMY_AI-dados]] | `C:\Users\v.tozeti\Desktop\Vitor\teste\Obsidian-vitor\projetos\KEMY_AI` (código no vault; `kemy.py`/zip fora do git — chave hardcoded) | ⭐[[mapa-projetos]] |
